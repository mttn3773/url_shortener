...
exports.logout = exports.me = exports.register = exports.login = exports.findAllUsers = void 0;
...
const me = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_model_1.default.findOne({ email: req.session.user.email }).exec();
